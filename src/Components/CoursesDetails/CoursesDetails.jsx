            ...
            <div className={styles.CoursesMoreInfo}>
                ...
                <ul className={styles.UL}>
                    ...
                    <li className={styles.LI} >
                        <p className={styles.titleDetail} >شهریه دوره : 66/500 تومان</p>
                    ...
                    <li className={styles.LI} >
                        <p className={styles.titleDetail} >ترم ارایه شده دوره :  تابستان</p>
                    <div className={styles.checkPic} >   
                        <img src={CheckPic} />
                        </div>             
                    </li>
                    ...
                    <li className={styles.LI} >
                        <p className={styles.titleDetail} >تاریخ شروع دوره : 1401/4/1</p>
                    <div className={styles.checkPic} >   
                        <img src={CheckPic} />
                        </div>             
                    </li>
                    ...
                    <li className={styles.LI} >
                        <p className={styles.titleDetail} >تاریخ پایان دوره : 1401/7/30</p>
                    <div className={styles.checkPic} >   
                        <img src={CheckPic} />
                        </div>             
                    </li>
                    ...
                    <li className={styles.LI} >
                        <p className={styles.titleDetail} >ظرفیت دوره : 40 نفر</p>
                    <div className={styles.checkPic} >   
                        <img src={CheckPic} />
                        </div>             
                    </li>
                    ...
                    <li className={styles.LI} >
                        <p className={styles.titleDetail} >تعداد دانشجو دوره : 20 نفر</p>
                    <div className={styles.checkPic} >   
                        <img src={CheckPic} />
                        </div>             
                    </li>
                ...
                <div className={styles.offSale}><p>20%</p></div>
            </div>

            <button className={styles.AddCourse}>  <p>ثبت دوره</p> </button>

            <div className={styles.LineOne}></div>
            <div className={styles.LineTwo}></div>
            <div className={styles.RelatedCourses}><p>دوره های مرتبط</p></div>
